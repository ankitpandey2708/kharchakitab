...
export const TransactionRowActions = memo(({
  ...
  return (
    <div
      ...
      className="hidden flex-none items-center justify-end gap-1 opacity-0 transition-opacity will-change-opacity sm:flex sm:opacity-0 sm:group-hover:opacity-100 sm:focus-within:opacity-100"
