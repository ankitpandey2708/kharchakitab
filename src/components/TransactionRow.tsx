  ...
  ({
    ...
    return (
      <motion.div
        ...
        className={`group relative flex items-center justify-between gap-3 overflow-hidden kk-radius-md border border-[var(--kk-smoke)] p-4 pl-3 pr-4 bg-white transform-gpu will-change-transform ${isClickable ? "cursor-pointer active:scale-[0.995]" : ""
          }`}
